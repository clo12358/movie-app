...
<form action="{{ route('directors.store') }}" method="post">
    ...
    <div>
        ...
        <span class="text-red-400"> {{ $errors->first('first_name') }} </span>
        @endif
    </div>
    <div>
        ...
        <span class="text-red-400"> {{ $errors->first('last_name') }} </span>
        @endif
    </div>
    ...
    <div>
    <form action="{{ route('directors.create') }}" method="POST" >
