...
<div class="px-4 sm:px-0">
    <h3 class="text-base font-semibold leading-7 text-gray-900">Add Director</h3>
</div>
...
<form action="{{ route('directors.store') }}" method="post">
    ...
    <div class="px-4 sm:px-0">
        ...
        <a href="{{ route('directors.index') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Back</a>
    </div>
</form>
