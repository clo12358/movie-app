...
<div class="px-10">
    <form action="{{ route('admin.movies.update', $movie->id) }}" method="POST">
        ...
        <div>
            ...
            <input type="text" name="name" id="name" value="{{ old('name') ? : $movie->name }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div>
            ...
            <input type="text" name="description" id="description" value="{{ old('description') ? : $movie->description }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <!-- adds error message beside the text box -->
        ...
        <div>
            ...
            <input type="text" name="run_time" id="run_time" value="{{ old('run_time') ? : $movie->run_time }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <!-- adds error message beside the text box -->
        ...
        <div>
            ...
            <input type="text" name="producer" id="producer" value="{{ old('producer') ? : $movie->producer }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <!-- adds error message beside the text box -->
        ...
        <div>
            ...
            <input type="date" name="release_date" id="release_date" value="{{ old('release_date') ? : $movie->release_date }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <!-- adds error message beside the text box -->
