...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    <a href="{{ route('admin.genres.show', $movie->genre_id) }}">
                ...
                <td class="px-6 py-4">
                    <a href="{{ route('admin.movies.show', $movie->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Read More</a>
