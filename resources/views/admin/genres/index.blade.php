...
@forelse($genres as $genre)
    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
        ...
        <a href="{{ route('admin.genres.show', $genre->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Read More</a>
        </td>
    </tr>
    @empty
